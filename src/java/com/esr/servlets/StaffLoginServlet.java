...
//            fetch username and password from request
            String userEmail = request.getParameter("staff_email");
            String userPassword = request.getParameter("staff_password");

            StaffDao dao = new StaffDao(ConnectionProvider.getConnection());

            Staff u = dao.getStaffByEmailAndPassword(userEmail, userPassword);
