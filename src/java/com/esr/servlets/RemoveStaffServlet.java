...
import com.esr.database.StaffDao;
...
public class RemoveStaffServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveStaffServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            StaffDao d = new StaffDao(ConnectionProvider.getConnection());
            
            if (d.removeStaffBStaffId(id)) {;
...
//                s.setAttribute("msg", msg);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveStaffServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
