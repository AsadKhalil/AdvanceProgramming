...
import com.esr.database.CustomerDao;
...
public class CustomerSignupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CustomerSignupServlet</title>");
            out.println("</head>");
            out.println("<body>");
...
//                save..
            ...
            Logger.getLogger(CustomerSignupServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
