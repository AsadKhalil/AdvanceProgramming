...
import com.esr.database.OwnerDao;
...
//            fetch username and password from request
            ...
            OwnerDao dao = new OwnerDao(ConnectionProvider.getConnection());

            Owner u = dao.getUserByEmailAndPassword(userEmail, userPassword);
...
//                login success 
            ...
            Logger.getLogger(OwnerLoginServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
